...
window.TREE_OPERATIONS = {
  ...
  nodes: {
    ...
    /* --------------------------------------------------------
       OPS-01 | Dia 1 | Control de peso en la linea de empaque
       -------------------------------------------------------- */
    "ops-01": {
      id: "ops-01",
      day: 1,
      ...
      options: [
        ...
        },
        {
          ...
          crossEffects: [{"area":"marketing","bsc":{"bsc_customer":-3},"narrative":"Mas quejas de clientes por paquetes livianos afectan la reputacion de marca en redes sociales."}],
          tags: ["risky","reactive"],
        ...
        },
        {
          ...
          crossEffects: [{"area":"finance","bsc":{"bsc_financial":-5},"narrative":"La inversion en maquinaria impacta el flujo de caja del trimestre."}],
    ...
    /* --------------------------------------------------------
       OPS-02 | Dia 4 | Proveedor nuevo de platano verde
       -------------------------------------------------------- */
    "ops-02": {
      id: "ops-02",
      day: 4,
    ...
    /* --------------------------------------------------------
       OPS-03 | Dia 7 | Lote para exportacion a Panama
       -------------------------------------------------------- */
    "ops-03": {
      id: "ops-03",
      day: 7,
      ...
      options: [
        {
          ...
          crossEffects: [{"area":"marketing","bsc":{"bsc_customer":-5},"narrative":"El cliente panameno rechaza el lote y publica su experiencia negativa en redes del sector."}],
        ...
        },
        {
          ...
          crossEffects: [{"area":"finance","bsc":{"bsc_financial":-2},"narrative":"El reproceso del lote de exportacion genera costos adicionales no presupuestados."}],
    ...
    /* --------------------------------------------------------
       OPS-04 | Dia 11 | Capacidad de produccion vs demanda pico
       -------------------------------------------------------- */
    "ops-04": {
      id: "ops-04",
      day: 11,
      ...
      options: [
        {
          ...
          crossEffects: [{"area":"hr","bsc":{"bsc_internal":-2},"narrative":"Los operarios existentes terminan haciendo horas extras agotadores sin planificacion."}],
          tags: ["risky","cost-focused"],
        ...
        },
        {
          ...
          crossEffects: [{"area":"hr","bsc":{"bsc_learning":6},"narrative":"Talento Humano gana experiencia gestionando turnos rotativos y contratacion temporal."}],
          tags: ["safe","expensive"],
    ...
    /* --------------------------------------------------------
       OPS-05 | Dia 12 | Turno de la manana vs turno de la noche
       -------------------------------------------------------- */
    "ops-05": {
      id: "ops-05",
      day: 12,
      ...
      options: [
        {
          ...
          crossEffects: [{"area":"hr","bsc":{"bsc_internal":-5,"bsc_customer":-2},"narrative":"Eliminar turno nocturno implica despidos o reasignaciones que generan conflicto laboral."}],
          tags: ["extreme"],
        ...
        },
        {
          ...
          crossEffects: [{"area":"hr","bsc":{"bsc_internal":-4},"narrative":"Despedir al coordinador sin investigar genera malestar y desconfianza en los demas empleados."}],
          tags: ["impulsive"],
        ...
        },
        {
          ...
          crossEffects: [{"area":"hr","bsc":{"bsc_learning":6},"narrative":"La investigacion revela oportunidades de mejora en condiciones laborales nocturnas."}],
    ...
    /* --------------------------------------------------------
       OPS-06 | Dia 14 | Automatizacion de la linea de empaque
       -------------------------------------------------------- */
    "ops-06": {
      id: "ops-06",
      day: 14,
    ...
    /* --------------------------------------------------------
       OPS-07 | Dia 15 | Lote urgente para D1
       -------------------------------------------------------- */
    "ops-07": {
      id: "ops-07",
      day: 15,
    ...
    /* --------------------------------------------------------
       OPS-08 | Dia 17 | La maquina hace ruidos raros
       -------------------------------------------------------- */
    "ops-08": {
      id: "ops-08",
      day: 17,
    ...
    /* --------------------------------------------------------
       OPS-09 | Dia 18 | Proveedor ofrece descuento por volumen
       -------------------------------------------------------- */
    "ops-09": {
      id: "ops-09",
      day: 18,
    ...
    /* --------------------------------------------------------
       OPS-10 | Dia 20 | INVIMA viene de visita
       -------------------------------------------------------- */
    "ops-10": {
      id: "ops-10",
      day: 20,
    ...
    /* --------------------------------------------------------
       OPS-11 | Dia 22 | Turno extra de fin de semana
       -------------------------------------------------------- */
    "ops-11": {
      id: "ops-11",
      day: 22,
    ...
    /* --------------------------------------------------------
       OPS-12 | Dia 24 | Nueva receta: platanitos con limon
       -------------------------------------------------------- */
    "ops-12": {
      id: "ops-12",
      day: 24,
